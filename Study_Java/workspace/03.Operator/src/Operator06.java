public class Operator06 {
	public static void main(String[] args) {
		...
		//L-Value = R-Value : R-Value의 값(연산의 결과)을 L-Value에 대입(할당)
		int a = 10;	//정수형 변수 a를 선언하고 값(10)을 할당(대입) → 초기화
		...
		//복합대입연산자 : R-Value에서 사용되는 변수(값)와 L-Value에 대입(할당)되는 변수가 동일할 때 사용
		a += a;	//a = a + a;
		System.out.println("변수 a의 값 : " + a);
